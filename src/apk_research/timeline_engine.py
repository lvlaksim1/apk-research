...
from apk_research import timeline as legacy
...
def _flow_summary(
    ...
    for packet in packets:
        ...
        if (
            ...
            and quic_version
            and quic_version
            not in quic_versions_seen
        ):
            quic_versions_seen.add(
                quic_version
            )
            quic_versions.append(
                quic_version
            )
        ...
        for alpn in (
            ...
            value = str(alpn or "").strip()
            if (
                value
                and value not in quic_alpn_seen
            ):
                quic_alpn_seen.add(value)
                quic_alpn.append(value)
        ...
        flows.append(
            {
                ...
                or [],
                "quic_versions": flow.get(
                    "quic_versions"
                )
                or [],
                "quic_packet_types": flow.get(
                    "quic_packet_types"
                )
                or [],
                "quic_alpn": flow.get(
